...
QUEUE_URL = "https://sqs.us-east-1.amazonaws.com/030615279213/Emarsys_genesys_integration_sqs_lcpr"  
...
def send_to_outbound_api_call_dev(messages_to_send):
    ...
    for i in range(0, len(messages_to_send), batch_size):
        ...
        response = lambda_client.invoke(
            FunctionName="arn:aws:lambda:us-east-1:030615279213:function:outbound_api_call_lcpr", 
