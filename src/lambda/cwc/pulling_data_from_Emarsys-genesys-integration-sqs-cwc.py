...
QUEUE_URL = "https://sqs.us-east-1.amazonaws.com/030615279213/Emarsys-genesys-integration-sqs-cwc"
...
def send_to_outbound_api_call_dev(messages_to_send):
    """
    Sends the collected messages to outbound_api_call_cwc in batches.
    """
    batch_size = 50  
    for i in range(0, len(messages_to_send), batch_size):
        ...
        # Send each batch to outbound_api_call_cwc
        response = lambda_client.invoke(
            FunctionName="arn:aws:lambda:us-east-1:030615279213:function:outbound_api_call_cwc", 
